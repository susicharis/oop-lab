            ...
            for(Book book : books) {
                for(int i = 0; i < field.length; i++) {
                    ...
                    if(field[i].isAnnotationPresent(WriteConcerns.class)) {
                        ...
                        } else if(field[i].get(book) instanceof Number && field[i].get(book) != null) {
                        ...
                        } else if(field[i].get(book) instanceof Date) {
                            SimpleDateFormat sdf = new SimpleDateFormat();
                            String formattedString = sdf.format((Date) field[i].get(book));
...
class Mein {
    public static void main(String[] args) {
        ...
        rw.writeReport("C:\\Users\\Haris\\Desktop\\temporary.csv", prep.getBookList());
